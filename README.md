# HSR
<img src="image/home_service.gif" width = "600"/>
...
<img src="image/slam_pgm.png" width = "400"/>
...
#### Add Markers 
<img src="image/add_markers.gif" width = "400"/>
1. Open ``Udacity-RoboND-Home-Service-Robot/Shell`` in Terminal  
2. give it ``execute`` pemission by ``chmod +x add_markers.sh``  
3. ``./add_markers.sh``  
#### Home Service
<img src="image/cover_hsr.gif" width = "400"/>
